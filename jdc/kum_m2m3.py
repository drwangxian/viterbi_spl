...
class Config:
    ...
    def __init__(self):
        ...
        self.tvt_split_dict['test'] = Config.get_mir1k_track_ids_fn()
    ...
    def __init__(self, config, name):
        ...
        if inferencing:
            if 'test' not in self.name:
                ...
                self.tf_dataset = TFDatasetForMir1k(self)
        else:
            if self.is_training:
